...
//
// Patched: the upstream `@Equatable` attribute was dropped along with the
// `Equatable` package dependency. The view still works the same; SwiftUI just
// cannot skip re-renders when the inputs are unchanged.
